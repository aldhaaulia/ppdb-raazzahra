  ...
  <?php $this->view('message')?>
      <section class="panel">
        <header class="panel-heading">
          ...
          <div class="text-left">
            <a href="<?=site_url('kegiatan')?>" class="btn btn-sm btn-danger"><i class="fa fa-undo"></i> Back</a>
          </div>
        </header>
          ...
          <?php echo form_open_multipart('kegiatan/process') ?>
            ...
            <div class="form-group">
              ...
              <div class="col-md-10">
                <?php if($subpage == 'Edit') {
                  if ($row->foto != null) {?>
                    <a class="img-thumbnail lightbox" href="<?=base_url('upload/kegiatan/'.$row->foto)?>" data-plugin-options="{ &quot;type&quot;:&quot;image&quot; }">
                      <img class="img-responsive" width="100px" src="<?=base_url('upload/kegiatan/'.$row->foto)?>">
                      <span class="zoom">
