  ...
  <?php $this->view('message')?>
      ...
      <div class="col-lg-13">
        <div class="panel-body">
          ...
          <img src="<?=base_url()?>assets/backend/assets/images/rincian.png" width="600" style="margin-bottom:15px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
            </div>
