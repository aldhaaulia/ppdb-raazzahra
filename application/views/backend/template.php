			...
			<header class="header">
				<div class="logo-container">
					<a href="<?=site_url('dashboard')?>" class="logo">
						<img src="<?=base_url()?>assets/backend/assets/images/raazzahra.jpg" height="35" alt="Porto Admin" />
					</a>
					...
					<div id="userbox" class="userbox">
						<a href="#" data-toggle="dropdown">
							<figure class="profile-picture">
								<img src="<?=base_url()?>assets/backend/assets/images/logoazzahraaa.png" alt="" class="img-circle" data-lock-picture="<?=base_url()?>assets/backend/assets/images/logoazzahraaa.png"/>
							</figure>
						...
						<div class="nano-content">
							<nav id="menu" class="nav-main" role="navigation">
								<ul class="nav nav-main">
									...
									<li class="nav-parent nav-<?=activate_menu('profil')?> nav-<?=activate_menu('kegiatan')?>">
										<a>
