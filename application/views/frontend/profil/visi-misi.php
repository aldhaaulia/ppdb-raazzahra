  ...
  <div class="container">
    <div class="row d-flex align-items-center justify-content-center">
      <div class="about-content col-lg-12">
        <h1 class="text-white">
        Visi dan Misi Raudhatul Athfal Az-Zahra
        </h1>
        <p class="text-white link-nav"><a href="<?=site_url('home')?>">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="<?=site_url('profil/visi_misi/4')?>"> Visi dan Misi Raudhatul Athfal Az-Zahra</a></p>
      </div>
    </div>
  </div>
</section>
