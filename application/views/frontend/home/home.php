<!-- start banner Area -->
<section class="banner-area relative" id="home" style="background:url(<?=base_url()?>assets/frontend/img/azzahrabg.png) center center; height: 650px; overflow: hidden; position: relative;">
  </style>
    ...
    <div class="row">
      <div class="col-lg-6">
        <div class="single-feature">
          ...
          <div class="desc-wrap">
            <p>Kegiatan ektra kulikuler RAUDHATUL ATHFAL AZ-ZAHRA ada 3 yaitu DrumBand, Sempoa, dan Renang</p>
      ...
      <div class="col-lg-6">
        <div class="single-feature">
          ...
          <div class="desc-wrap">
            <p>Fasilitas sekolah RAUDHATUL ATHFAL AZ-ZAHRAa</p>
            <a class="genric-btn info-border circle medium" href="<?=site_url('home/ppdb')?>">Join Now</a>
          </div>
        </div>
      </div>
    ...
    <div class="row d-flex justify-content-center">
      <div class="menu-content pb-70 col-lg-12">
        <div class="title text-center">
          <h1 class="mb-10">Berita Terkini RAUDHATUL ATHFAL AZ-ZAHRA</h1>
          <p>Ikuti terus informasi dan berita-berita terbaru tentang RAUDHATUL ATHFAL AZ-ZAHRA.</p>
        </div>
      </div>
    </div>
    <div class="row">
      ...
      <div class="col-lg-3 col-md-6 single-blog">
        ...
        <p class="meta">By RAUDHATUL ATHFAL AZ-ZAHRA <br> Post : <?=date_indo($date);?></p>
...
<section class="cta-one-area relative section-gap" style="background:url(<?=base_url()?>assets/frontend//img/logoazzahraaa.png) center; background-repeat: no-repeat;
...
<section class="gallery-area section-gap" id="galeri">
          ...
          <div class="row d-flex justify-content-center">
            <div class="menu-content pb-70 col-lg-12">
              <div class="title text-center">
                <h1 class="mb-10">Galeri Terbaru RAUDHATUL ATHFAL AZ-ZAHRA</h1>
                <p>Ikuti terus dokumentasi foto dan video terbaru tentang RAUDHATUL ATHFAL AZ-ZAHRA.</p>
              </div>
            </div>
          </div>
					<div class="row">
