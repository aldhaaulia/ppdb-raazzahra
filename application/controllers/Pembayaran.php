  ...
  public function cek($id)
  {
	...
	public function cetak_pembayaran($id)
	{
		...
		$pdf = new FPDF('P','mm',array(215,330));
				 ...
				 $pdf->Cell(12,6,'',0,1);
				 $pdf->Cell(7,6,'1',1,0);
				 $pdf->Cell(80,6,'Dana Pendidikan (SSP) per bulan ',1,0);
				 $pdf->Cell(40,6,'Rp. 200.000',1,0);
				 $pdf->Cell(60,6,'SPP Sudah dibayarkan bulan juli',1,0);

				 $pdf->Cell(12,6,'',0,1);
				 $pdf->Cell(7,6,'2',1,0);
				 $pdf->Cell(80,6,'Kegiatan Ekstrakulikuler per bulan',1,0);
				 $pdf->Cell(40,6,'Rp. 200.000',1,0);
				 $pdf->Cell(60,6,'Untuk per bulan',1,0);

				 $pdf->Cell(12,6,'',0,1);
				 $pdf->Cell(7,6,'3',1,0);
				 $pdf->Cell(80,6,'Seragam Sekolah',1,0);
				 $pdf->Cell(40,6,'Rp. 600.000',1,0);
				 $pdf->Cell(60,6,'Untuk dipake selamanya',1,0);

				 $pdf->Cell(12,6,'',0,1);
				 $pdf->Cell(7,6,'4',1,0);
				 $pdf->Cell(80,6,'Formulir Pendaftaran',1,0);
				 $pdf->Cell(40,6,'Rp. 100.000',1,0);
				 $pdf->Cell(60,6,'-',1,0);
				 ...
				 $pdf->Cell(40,6,'Rp. 1.110.000',1,0);
				 $pdf->Cell(60,6,'',1,0);

				 $pdf->SetFont('Times','I',12);
				 $pdf->SetY(145);
				 $pdf->Cell(7,7,'');
				 $pdf->Cell(65,7,'Terbilang: Satu Juta Seratus Sepuluh Ribu Rupiah');
				 ...
				 $pdf->SetY(145);
				 $pdf->SetX(150);
				 $pdf->Cell(65,7,'Jakarta, '.date_indo(date('Y-m-d')),'C');
