...
class Profil extends CI_Controller {
	...
	function __construct()
  {
	...
	{
		$data = array(
      'page' => "Sejarah Raudhatul Athfal Az-Zahra",
	...
	{
		$data = array(
			'page' => "Visi dan Misi Raudhatul Athfal Az-Zahra",
	...
	{
		$data = array(
			'page' => "Struktur Organisasi Raudhatul Athfal Az-Zahra",
	...
	{
		$data = array(
			'page' => "Kontak Kami Raudhatul Athfal Az-Zahra",
		);
