	...
	public function process_register()
	{
		...
		if (isset($_POST['add'])) {
			if($this->M_user->cek_username($post['username'])->num_rows() > 0){
               ...
               'charset'   => 'utf-8',
               'protocol'  => 'smtp',
               'smtp_host' => 'ssl://mail.raazzahra.site',
               'smtp_user' => 'ra.azzahra@gmail.com.site',    // Ganti dengan email gmail kamu
               'smtp_pass' => 'admin',      // Password gmail kamu
               'smtp_port' => 465,
               'crlf'      => "\r\n",
               'newline'   => "\r\n"
           ];
				...
				$this->email->from('', 'PPDB Online');
				$this->email->to($post['email']);

				$this->email->subject('Registrasi Berhasil ! | PPDB Online RA AZ-ZAHRA');
				$this->email->message("Hai kamu berhasil registrasi akun PPDB Online RA AZ-ZAHRA<br>
